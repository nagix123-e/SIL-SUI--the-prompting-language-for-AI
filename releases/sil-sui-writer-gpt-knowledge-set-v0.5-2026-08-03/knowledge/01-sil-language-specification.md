...
> New Writer output is SIL/SUI v0.5. This file documents v0.1 input compatibility only; use `14-v0.5-ui-layers-and-continuation.md` for canonical output and `13-v0.4-bounded-loops.md` for bounded loops.
