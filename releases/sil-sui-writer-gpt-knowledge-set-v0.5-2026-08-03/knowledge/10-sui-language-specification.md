...
> New SUI output uses v0.5 nested components and four-space indentation. This file preserves v0.1 brace-syntax input compatibility; see `14-v0.5-ui-layers-and-continuation.md` for design layers and `13-v0.4-bounded-loops.md` for collection rendering.
