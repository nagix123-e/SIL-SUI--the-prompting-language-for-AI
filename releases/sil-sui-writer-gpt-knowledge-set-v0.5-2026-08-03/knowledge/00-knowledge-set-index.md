...
Version: SIL/SUI v0.5 (with SIL/SUI v0.1-v0.4 input compatibility)
Knowledge build: 2026-08-03
...
9. `09-indented-sil-output.md` — v0.5 four-space canonical layout and legacy display compatibility.
...
14. `14-v0.5-ui-layers-and-continuation.md` — SUI design layers and non-blocking extension continuation.
...
This set contains all current SIL/SUI grammar, deterministic multilingual-to-English conversion rules, technical/proper-name behavior, validation and readiness rules, quantization rules, response policy, examples, and the full 10,000-entry Core v0.1 codebook. The v0.1-v0.4 files document compatibility; `14-v0.5-ui-layers-and-continuation.md` governs new output.
